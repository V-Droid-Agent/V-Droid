...
def setup_datetime_lab(env: env_interface.AndroidEnvInterface) -> None:
  """Prepares the Android device's date and time settings for benchmarking.
...
def _enable_12_hour_format(env: env_interface.AndroidEnvInterface) -> None:
  adb_utils.put_settings(
      adb_pb2.AdbRequest.SettingsRequest.Namespace.SYSTEM,
      'time_12_24',
      '12',
