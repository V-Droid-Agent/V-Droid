...
_PATTERN_TO_ACTIVITY = immutabledict.immutabledict({
    ...
    'zoom|us.zoom.videomeetings|zoom app': (
      'us.zoom.videomeetings/com.zipow.videobox.LauncherActivity'
    ),
    'bluecoins|bluecoins app': (
      'com.rammigsoftware.bluecoins/.activities.main.ActivityMain'
    ),
    'mapme|mapme app|maps|map': (
      'com.mapswithme.maps.pro/com.mapswithme.maps.MainActivity'
    ),
    'pimusic|pi music|pimusic app|PiMusicPlayer': (
      'com.Project100Pi.themusicplayer/com.project100Pi.themusicplayer.ui.activity.SplashActivity'
    ),
    'cantook|cantook app|Cantook': (
      'com.aldiko.android/com.demarque.android.ui.splash.SplashActivity'
    ),
    'calendar|Calendar|calendar app':(
      'com.skuld.calendario/.ui.splash.SplashScreenActivity'
    ),
    'calculator|simple calculator':(
      'com.simplemobiletools.calculator/.activities.MainActivity'
    ),
    'simple music player|music player':(
      'com.simplemobiletools.musicplayer/.activities.MainActivity'
    ),
    'Files|file|files|file manager|filemanager':(
      'com.simplemobiletools.filemanager.pro/.activities.MainActivity'
    ),
    'applauncher|launcher|Launcher|app launcher':(
      'com.simplemobiletools.applauncher/.activities.MainActivity'
    ),
    'voice recorder|simple voice recorder|voicerecorder': (
      'com.simplemobiletools.voicerecorder/.activities.MainActivity'
    ),
    'note|notes|Note|Notes|simple notes': (
      'com.simplemobiletools.notes.pro/.activities.MainActivity'
    ),
    'simple contacts|simple contacts pro': (
...
def clear_text(
    ...
    response = issue_generic_request(
      ['shell', 'input keycombination 113 29 && input keyevent 67'],
      # 'shell "input keycombination 113 29 && input keyevent 67"',
      env,
      timeout_sec,
    )
    if response.status != adb_pb2.AdbResponse.Status.OK:
      logging.error('Failed to clear input')
